    ...
    return (
        ...
        <Box width="80%" margin="auto" display="flex" justifyContent="space-between" flexWrap="wrap" rowGap="30px" columnGap="clamp(20px, 30px, 40px)" >
            <Box width="clamp(20%, 30%, 40%)">
                ...
                <div>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Expedita facilis aut earum atque. Voluptatibus officiis, nihil itaque a delectus, aspernatur repellendus, accusamus explicabo inventore quisquam perferendis magnam impedit nostrum optio!</div>
            </Box>
            <Box>
            ...
            <Typography variant="h4" fontWeight="bold" mb="30px">Contact us</Typography>
                <Typography mb="30px">Nicolae Iorgr Blvd, Iasi, 700235</Typography>
                <Typography mb="30px">Email: something@gmail.com</Typography>
                <Typography mb="30px">(333)555-6666</Typography>
            </Box>
        </Box>
        </Box>
    )
